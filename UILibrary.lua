...
local library = {
    ...
    pointers = {},
    settings = {
        guiname = "ESMichal Destroyer",
		title = "ESMichal Destroyer [RIP BOZO]",
    ...
    theme = {
        buttons = Color3.fromRGB(161, 84, 255), -- toggle, sliders colors
        text = Color3.fromRGB(161, 84, 255),
        textboxtext = Color3.fromRGB(161, 84, 255),
        main = Color3.fromRGB(161, 84, 255),
        outline = Color3.fromRGB(161, 84, 255),
        tabholder = Color3.fromRGB(161, 84, 255),
        tabbutton = Color3.fromRGB(161, 84, 255),
        tabselected = Color3.fromRGB(161, 84, 255)
    }
}
...
function library:Notify(title, message, time, buttons, _function)
	...
	notification.window = library:create("TextLabel", {
		...
		BackgroundColor3 = Color3.fromRGB(161, 84, 255),
		Text = "",
		Name = "Notification",
		Parent = library.base
	})
	...
	for i,v in pairs(notification.settings.buttons) do
		notification["button"..i] = library:create("TextButton", {
			...
			Text = v,
			TextSize = 14,
			TextColor3 = Color3.fromRGB(161, 84, 255),
			Font = "Code",
...
function library:CreateWindow(csize, cpos)
	...
	window.shade = self:create("ImageLabel", {
		...
		ImageColor3 = Color3.fromRGB(161, 84, 255),
